...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <p>1. Berkas atau Kelengkapan Pemohon diregistrasi Petugas</p>
        <p>2. Persyaratan Pemohon diregistrasi dan Cek DTKS Oleh Petugas Dinas Sosial</p>
        <p>3. Pembuatan Surat Rrekomendasi, Surat Keterangan Tercatat DTKS dan Surat Keterangan dalam Proses Pencatatan DTKS</p>
        <p>4. Rekomendasi yang ditandatangani oleh Kepala Dinas atau Pejabat Strukturan</p>
      </div>
		</div>

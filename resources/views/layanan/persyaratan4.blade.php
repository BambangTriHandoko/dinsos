...
<html lang="en">
  ...
  <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <p>1. Surat Pengantar Permohonan dan Pendaftaran LKS;</p>
        <p>2. Formulir Pendaftaran (Form disediakan Dinas Sosial);</p>
        <p>3. Akta Pendirian Lembaga Kesejahteraan Sosial (LKS);</p>
        <p>4. Anggaran Dasar dan Anggaran Rumah Tangga LKS;</p>
        <p>5. Sturuktur Organisasi dan Personalia Kepengurusan LKS;</p>
        <p>6. Nama, Alamat dan Telepon Pengurus LKS (Ketua, Sekretaris, Bendahara).</p>
        <p>7. Fotocopy KTP dan NPWP Pengurus LKS</p>
        <p>8. Program dan Kegiatan Pelayanan di Bidang Sosial</p>
        <p>9. Surat Keterangan Domisili Sekretariat LKS dari Kelurahan Setempat
</p>

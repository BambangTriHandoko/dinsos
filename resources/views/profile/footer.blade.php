...
<footer id="footer">
			...
			<div class="container">
				...
				<div id="custom_html-3" class="widget_text widget widget_custom_html"><span><h5><b>HUBUNGI KAMI</b></h5></span><div class="textwidget custom-html-widget"><center>
	<table id="tabel-kontak">
		<tbody><tr>
			<td><span class="fa fa-map-marker" style="font-size:1.2em">:</span></td>
			<td><a href="https://goo.gl/maps/1vzohfFLxDwi6Any6" ><h5>Jl. Ir H Djuanda Komplek Perkantoran<h5></a></td>
		</tr>
		<tr>
